...
<div class="main_wrapper">
    ...
    <div class="container radio2-container"><!-- Main container Strats--> 
		...
		<div class="row"><!-- Main row Starts-->
			<div class="col-ie-3 col-xs-3 col-sm-12 col-md-3 col-lg-3 logo"><!-- col-md-3 Starts-->
				
			</div><!-- col-md-3 Ends-->
			<div class="col-ie-7 col-xs-7 col-sm-12 col-md-7 col-lg-7 timed_banner"><!-- col-md-7 Starts-->
				
			</div><!-- col-md-7 Ends-->
            
			<div class="col-ie-2 col-xs-2 col-sm-12 col-md-2 col-lg-2 listen_live"><!-- col-md-2 Starts-->
		...
		<!-- Slideshow Starts -->
		<div class="row">
			<div class="col-ie-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 no_padding_left"><!-- col-md-12 Starts-->
						...
						<div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 810px; height: 300px; background: #000; overflow: hidden; ">
							...
							<div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 600px; height: 300px;
								...
								<div>
									<img u="image" src="sites/all/themes/bootstrap/bootstrap_subtheme/img/content/large/slideshow_images/002.jpg" />
									<div u="thumb">
										<img class="i" src="sites/all/themes/bootstrap/bootstrap_subtheme/img/content/large/slideshow_images/thumbs/thumb-002.jpg" /><div class="t">Image Gallery</div>
							...
							<div u="thumbnavigator" class="jssort11" style="position: absolute; width: 200px; height: 300px; left:605px; top:0px;">
								...
								<div u="slides" style="cursor: move;">
									<div u="prototype" class="p" style="position: absolute; width: 200px; height: 145px; top: 0; left: 0;">
		...
		<div class="row"><!-- Main row Starts-->
			...
			<div class="row">
				<div class="col-ie-6 col-xs-6 col-sm-12 col-md-6">
					<div class="redcolor">
						<iframe width="290" height="175" src="https://www.youtube.com/embed/ZyfLdydDxM8" frameborder="0" allowfullscreen></iframe>
					</div>
				...
				<div class="col-ie-6 col-xs-6 col-sm-12 col-md-6 vertical_seperator">
					<div class="redcolors">
						<iframe width="290" height="175" src="https://www.youtube.com/embed/Tsz6G-OXxBw" frameborder="0" allowfullscreen></iframe>
					</div>
					<div class="video_description">
						GN TV
					</div>
			...
			<div class="row"><!-- row Starts-->
					<div class="col-ie-3 col-xs-12 col-sm-12 col-md-3 col-lg-3">
						<div class="col-md-12 greycolor"> <!-- Newly Added Starts -->
							
						</div>	<!-- Newly Added Ends -->
						<div class="col-md-12">Lorem Ipsum Dolar Sit 1</div>
					</div>
					<div class="col-ie-3 col-xs-12 col-sm-12 col-md-3 col-lg-3 vertical_seperator_tabloid">
						<div class="col-md-12 lightgreycolor"> <!-- Newly Added Starts -->
							
						</div>	<!-- Newly Added Ends -->
						<div class="col-md-12">Lorem Ipsum Dolar Sit 2</div>
					</div>
					<div class="col-ie-3 col-xs-12 col-sm-12 col-md-3 col-lg-3 vertical_seperator_tabloid">
						<div class="col-md-12 greycolors"> <!-- Newly Added Starts -->
							
						</div>	<!-- Newly Added Ends -->	
						<div class="col-md-12">Lorem Ipsum Dolar Sit 3</div>
					</div>
					<div class="col-ie-3 col-xs-12 col-sm-12 col-md-3 col-lg-3 vertical_seperator_tabloid">
						<div class="col-md-12 lightgreycolors"> <!-- Newly Added Starts -->
							
						</div>	<!-- Newly Added Ends -->	
						<div class="col-md-12">Lorem Ipsum Dolar Sit 4</div>
					</div>
			</div>  <!-- row end-->
			<!-- Tabloid Ends -->
			...
			<div class="row"><!-- row Starts-->
				<div class="col-ie-4 col-sm-12 col-md-4 whitecolor"><!-- col-md-4 Starts-->
				...
				<div class="col-ie-4 col-sm-12 col-md-4 whitecolor vertical_seperator"><!-- col-md-4 Starts-->
			...
			<!-- Music Starts-->
			<div class="row"><!-- row Starts For Heading-->
				<div class="col-ie-12 col-sm-12 col-xs-12 col-md-12 lime_yellow_color">
					<h2>Music</h2>
				</div>
			</div><!-- row Ends For Heading-->
			<div class="row">
				<div class="col-ie-1 col-sm-1 col-xs-1 col-md-1 kennyshow_number">
					<p>01</p>
				</div>
				<div class="col-ie-1 col-sm-1 col-xs-1 col-md-1 kennyshow_number">
					<p>02</p>
				</div>
				<div class="col-ie-7 col-sm-7 col-xs-7 col-md-7 kennyshow_contents">
					<p>Kenny Show</p>
				</div>
				
				
				<!-- -->
				<div class="col-ie-1 col-sm-1 col-xs-1 col-md-1 kennyshow_play">
					<p>Play</p>
				</div>
				
				<div class="col-ie-1 col-sm-1 col-xs-1 col-md-1 kennyshow_pause">
					<p>Pause</p>
				</div>
				<div class="col-ie-1 col-sm-1 col-xs-1 col-md-1 kennyshow_contents">
			...
			<div class="col-ie-4 col-sm-12 col-md-4 facebook_right no_padding"><!-- col-md-4 Starts--> 
				<!-- Social Tab Starts-->
				<div id="tabContainer">
					<div id="tabs">
					  <ul>
				...
				<iframe src="//www.facebook.com/plugins/likebox.php?href=https%3A%2F%2Fwww.facebook.com%2FRadio2UAE&amp;width=240&amp;height=395&amp;colorscheme=light&amp;show_faces=false&amp;header=false&amp;stream=true&amp;show_border=false&amp;appId=674151015978019" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:260px; height:395px;" allowTransparency="true"></iframe>
					  </div>
					  
					  <div class="tabpage" id="tabpage_2">
				<iframe src="//www.facebook.com/plugins/likebox.php?href=https%3A%2F%2Fwww.facebook.com%2FRadio1UAE&amp;width=240&amp;height=395&amp;colorscheme=light&amp;show_faces=false&amp;header=false&amp;stream=true&amp;show_border=false&amp;appId=674151015978019" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:260px; height:395px;" allowTransparency="true"></iframe>
					  </div>
			...
			<div class="col-ie-4 col-sm-12 col-md-4 no_padding_left"><!-- col-md-4 Starts--> 
				<div class="advertisement_right">
					Advertisement
				</div>
			</div><!-- col-md-4 Ends-->
		
			<div class="col-sm-12 col-md-4 photos_right_header">
			<p>Photos</p>
			</div>
			...
			<div class="col-ie-4 col-sm-12 col-md-4 blog_right"><!-- col-md-4 Starts--> 
				<p>Second Ad</p>
			</div><!-- col-md-4 Ends-->
			
			<div class="col-ie-4 col-sm-12 col-md-4 weather_right"><!-- col-md-4 Starts--> 
				<p>Weather</p>
			</div><!-- col-md-4 Ends-->
