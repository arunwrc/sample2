    ...
    <div class="container radio2-container"><!-- Main container Strats--> 
		...
		<div class="row"><!-- Row Starts -->
			<div class="col-ie-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 no_padding top_margin15 win_banner_holder"><!-- col-md-12 Starts-->
				<img src="sites/all/themes/bootstrap/bootstrap_subtheme/img/content/large/Music_banner.png">
			</div><!-- col-md-12 Ends-->	
		</div><!-- Row Ends -->
		<!-- Slideshow Ends -->
		<!-- Breadcrumb Starts -->
		<div class="row"><!-- Row Starts -->
			<div class="col-lg-12 col-md-12 col-ie-12 col-sm-12 col-xs-12 contact_breadcrumb">
				<a href="index.php">HOME</a> <span class="contact_breadcrumb_link">&nbsp;&nbsp;>&nbsp;&nbsp;MUSIC</span>
			</div>
		</div><!-- Row Ends -->
		<!-- Breadcrumb Ends -->
		...
		<div class="row"><!-- Main row Starts-->
			...
			<div class="row"><!-- row Starts For Heading-->
					<div class="col-ie-12 col-md-12 contact_title">
						<div class="content_title">RADIO 2 MUSIC</div>
					</div>
			...
			<!-- -->
				...
				<?php 
	 			$slides = node_load_multiple(array(), array('type' => 'add_music_albums','status' => '1'),array('status' => 'Regular'));
	 			 $i=2; 
	   			 foreach($slides as $slide):
	   			 	
				?>
	 			<div class="album_wrapper"> <!--Album Wrapper Starts -->
	 				<?php if  ($slide->field_status['und'][0]['value'] == "Exclusive") { ?>
	 				<img class="exclusive_music_status" src="sites/all/themes/bootstrap/bootstrap_subtheme/img/content/large/img_trans.gif">
	    			<div class="exclusive_music" style="background-image: url(<?php print file_create_url($slide->field_artwork_image['und'][0]['uri']); ?>);height: 185px; width: 385px; ">
	    			<?php } else { ?>

	    			<img class="regular_music_status" src="sites/all/themes/bootstrap/bootstrap_subtheme/img/content/large/img_trans.gif">
	    			<div class="regular_music_counter"> <?php echo $i; ?> </div>
	    			<div style="background-image: url(<?php print file_create_url($slide->field_artwork_image['und'][0]['uri']); ?>);height: 185px; width: 185px; ">
	    				<?php $i=$i+1; ?>
	    			<?php }	?>
	    				<div  class="ui360">
	    					<a href="<?php print file_create_url($slide->field_album_audio_file['und'][0]['uri']); ?>"></a>
	    				</div>

	    			</div>
	    			<?php //echo "<pre>"; print_r($slide); echo "</pre>"; ?>
	    		
	    		<div><?php print $slide->title;  ?></div>
	    		<div><?php print $slide->field_song_title['und'][0]['safe_value']; ?> </div>
	    		<div><?php print $slide->field_album_artist_name['und'][0]['safe_value']; ?> </div>
	    		<div><?php print $slide->field_status['und'][0]['value']; ?> </div>

	    		</div><!--Album Wrapper Ends -->
	    		<?php  //echo "<pre>"; print_r($slide); echo "</pre>";?>
